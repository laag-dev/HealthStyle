...
const Result = () => {
  return (
    <div id='resultadosLink' className="flex flex-col max-w-[1600px] mx-auto lg:flex-row justify-between items-start p-4 lg:p-20">
      <div className="bg-white lg:ml-6 lg:mr-4 w-full lg:w-1/2 pr-0 lg:pr-4">
        ...
        <h1 className="text-xl xs:text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-4xl font-bold mb-4 text-left">CONSTRUIDO PARA OBTENER</h1>

        <h1 className="text-xl xs:text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-4xl font-bold mb-4 text-left">
        LOS MEJORES <span className='text-[#3E9278]'>RESULTADOS</span>
        </h1>
        ...
        <div className="text-left">
          <a href="#contactoLink" className="bg-[#74BAA0] hover:bg-[#D1E1D4] text-white font-bold py-2 px-4 lg:py-3 lg:px-6 rounded-full mt-2 lg:mt-4 mb-4 lg:mb-0 inline-block">
            Contactanos
          </a>
        </div>
      </div>
      <div className="bg-white   lg:ml-4 lg:mr-6 w-full lg:w-1/2 flex justify-center items-center h-full">
