...
const Planes = ({ titulo, precio, plan, boton, addToCart, message, setMessage, selected }) => {
  ...
  return (
    <div className='planes bg-[black] h-[320px] w-[250px] text-[white] rounded-[20px] hover:bg-[#216651]'>
      ...
      <button 
        className={`bg-[#74BAA0] hover:bg-[#D1E1D4] text-white font-bold py-4 px-6 lg:py-3 lg:px-6 rounded-full mt-2 lg:mt-4 mb-4 lg:mb-0 inline-block`} 
    ...
    <div id="costosLink" className="flex flex-col ">
      <div className="mx-auto px-8 text-center">
        ...
        <h3 className="text-5xl font-bold py-8 mb-4">
          ELIGE TU
          <span className="text-[#216651]"> PLAN</span>
          <span className="text-5xl font-bold py-8 mb-4"> DE PRECIOS</span>
        </h3>
      </div>
